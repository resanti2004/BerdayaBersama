...
const PilihInformasiGermas = () => {
  const [showAll, setShowAll] = useState(false);

  const infos = [
    {
      id: "edukasi-kesehatan-reproduksi-wanita",
      title: "Edukasi Kesehatan Reproduksi Wanita",
    },
    { id: "edukasi-bahaya-nyamuk", title: "Edukasi Bahaya Nyamuk" },
    { id: "pola-makan-gizi-seimbang", title: "Pola Makan Gizi Seimbang" },
    { id: "aktivitas-fisik-rutin", title: "Aktivitas Fisik Rutin" },
    {
      id: "pengelolaan-stress-dan-kesehatan-mental",
      title: "Pengelolaan Stres dan Kesehatan Mental",
    },
  ];
  ...
  const handleItemClick = (itemId) => {
    console.log(`Navigating to: /germas/${itemId}`);
...
export default PilihInformasiGermas;
